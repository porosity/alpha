...
function i18nResolveSanitizer(attrName, tagName) {
  ...
  const schemaContext = schema[`${lowerTagName}|${lowerAttrName}`] || (namespace ? schema[`:${namespace}:*|${lowerAttrName}`] : undefined) || schema[`*|${lowerAttrName}`] || SecurityContext.NONE;
